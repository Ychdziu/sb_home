...
/*
    ...
    ------  -----------  ------------
      ...
      AJ    2026-07-13   #REF v1.2.0 - new function "get_unpaid_invoices" for TASK_5
...
*/
function get_unpaid_invoices return sys_refcursor;
end sb_core;
/
...
/*
  Gets unpaid invoices
*/
function get_unpaid_invoices return sys_refcursor is
